...
exports.deleteFunctionModule = deleteFunctionModule;
...
async function checkDeletion(connection, params) {
    ...
    const encodedGroupName = (0, internalUtils_1.encodeSapObjectName)(function_group_name);
    const encodedModuleName = (0, internalUtils_1.encodeSapObjectName)(function_module_name);
 ...
 */
async function deleteFunctionModule(connection, params) {
