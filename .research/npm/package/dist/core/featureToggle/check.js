...
exports.checkFeatureToggle = checkFeatureToggle;
 ...
 */
async function checkFeatureToggle(connection, name, version, xmlContent) {
    if (!name) {
...
<chkrun:checkObjectList xmlns:chkrun="http://www.sap.com/adt/checkrun" xmlns:adtcore="http://www.sap.com/adt/core">
  <chkrun:checkObject adtcore:uri="${uri}" chkrun:version="${version}">
    <chkrun:artifacts>
      <chkrun:artifact chkrun:contentType="${contentTypes_1.CT_FEATURE_TOGGLE_METADATA}" chkrun:uri="${uri}">
