...
exports.unlockScalarFunctionImplementation = unlockScalarFunctionImplementation;
const internalUtils_1 = require("../../utils/internalUtils");
const timeouts_1 = require("../../utils/timeouts");
async function unlockScalarFunctionImplementation(connection, name, lockHandle) {
