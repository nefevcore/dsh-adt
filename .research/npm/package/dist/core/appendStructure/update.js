...
exports.updateAppendStructure = updateAppendStructure;
const contentTypes_1 = require("../../constants/contentTypes");
const internalUtils_1 = require("../../utils/internalUtils");
const timeouts_1 = require("../../utils/timeouts");
async function updateAppendStructure(connection, args, lockHandle) {
    const encoded = (0, internalUtils_1.encodeSapObjectName)(args.append_structure_name.toLowerCase());
