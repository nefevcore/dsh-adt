...
export const ENDPOINTS = {
    ...
    createByType: {
         ...
         */
        DDLS: (query) => `${ADT_BASE}/ddic/ddl/sources${toQuery(query)}`,
        ...
        DCLS: (query) => `${ADT_BASE}/acm/dcl/sources${toQuery(query)}`,
        /** CDS metadata extension. CT ddic.ddlx.v1, body `<ddlxsources:ddlxSource>`. */
        DDLX: (query) => `${ADT_BASE}/ddic/ddlx/sources${toQuery(query)}`,
        /**
         ...
         * prefix.
         */
        BDEF: (query) => `${ADT_BASE}/bo/behaviordefinitions${toQuery(query)}`,
        /**
         ...
         * form 400s).
         */
        SRVD: (query) => `${ADT_BASE}/ddic/srvd/sources${toQuery(query)}`,
    },
