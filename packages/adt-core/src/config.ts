 ...
 */
export function workspaceConfigCandidates(cwd: string, configDir: string = DEFAULT_WORKSPACE_CONFIG_DIR): string[] {
 ...
 */
export function workspaceConfigPath(cwd: string, configDir: string = DEFAULT_WORKSPACE_CONFIG_DIR): string {
  return (
    workspaceConfigCandidates(cwd, configDir).find((p) => existsSync(p)) ??
