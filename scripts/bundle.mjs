 ...
 * resolved from the host profile). Recipients point their agent preset's
 * plugin row `name` at this file — e.g. the abap-adt row of the preset
 * generated by `abap-adt-preset` — no monorepo or build needed.
 *
